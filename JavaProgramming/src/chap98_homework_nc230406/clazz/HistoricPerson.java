package chap98_homework_nc230406.clazz;
...
public class HistoricPerson {
	...
	public String getPersonInfo(String achievement) {
		String info = this.name + ", " + this.achievement + ", " + this.country;
	...
	public String getSameCountryPerson(String country) {
		...
		return (country == this.country) ? this.name + ", " + this.achievement + ", " + this.country : "";
...
//	사용자가 입력한 업적 하나만 갖는 스트림을 생성하고 출력하세요. distinct() 사용해볼 수 있겠다.
