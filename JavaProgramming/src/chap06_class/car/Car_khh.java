...
//	
	...
	public String toString() {
		return "Car [company=" + Arrays.toString(company) + ", model=" + Arrays.toString(model) + ", color="
				+ Arrays.toString(color) + ", price=" + Arrays.toString(price) + "]";
	}


	public static void main(String[] args) {
		Car_khh car = new Car_khh();
